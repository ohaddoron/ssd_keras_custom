rom keras.optimizers import Adam, SGD
...
images_path      = '../CV-project/Augmented_Buses/'
VOC_2012_images_dir      = '../CV-project/Augmented_Buses/'

# The directories that contain the annotations.
labels_path      = '../CV-project/AugmentatedAnnotations.csv'
...
classes = ['green','yellow','white','grey','blue','red']
